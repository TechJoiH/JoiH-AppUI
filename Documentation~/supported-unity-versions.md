...
当前 `main` 上的 `0.2.0-pre.1` 是 Unity 6 Official Target 下的预发布候选，已有 EditMode、PlayMode 和 Mono 构建证据，但仍缺少 IL2CPP 完成结果、不可变 Tag 和 Tag URL 安装冒烟，因此不能标记为 `Officially Supported`。
